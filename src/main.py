...
def main() -> None:
    ...
    # In-memory ZIP field rendering for simulation .npy results (Input-only grid resolution)
    try:
        ...
        if grid_bounds is None:
            raise KeyError("No valid 'grid' found in inputs.")
    ...
    # Construct merged output structure
    final_output = {
